...
(function(root){
 ...
 const stations=[
  ...
  {id:'boba',n:5,...venueRect(monza.boba),title:'BOBA CART',lines:['Inside Monza','Near rear-lobby entry'],detail:'Boba cart inside Monza with its long side against the rear wall, tight to the rear-lobby doorway (0.5 ft clear of the door swing). Staff space sits behind the cart; a separate 3.5-ft queue runs along the wall away from the door. Confirm the supplier footprint and service direction.'},
