...
(function(root){
 ...
 const stations=[
  ...
  {id:'boba',n:5,x:562,y:1075,w:26,h:62.4,title:'BOBA CART',lines:['With the bar','Front lobby'],detail:'Boba moved out of Monza to sit with the bar in the front lobby, as decided with Fay on Sep 22 and shown on her Sep 25 floorplan. Staff stand against the wall behind the cart; the queue lines up beside it, clear of the front door. Confirm power with Fay and Olta.'},
  {id:'booth',n:6,x:568,y:916,w:83.2,h:83.2,title:'PHOTO BOOTH',lines:['8 × 8 ft working area'],detail:'Photo booth in the front entrance lobby near the bar. Reserve an 8 × 8-ft working area and a separate 4 × 6-ft queue; confirm the actual booth footprint and power.'},
  ...
  {id:'trio',n:8,x:757,y:1082,w:80,h:60,title:'JAZZ TRIO',lines:['Front lobby · cocktail hour'],detail:'Jazz trio in the front entrance lobby for cocktail hour, below the bar and clear of the front door. An 8 × 6-ft area is shown; confirm instruments, power and sound needs.'}
 ];
