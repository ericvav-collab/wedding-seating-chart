...
(function(root){
 ...
 const stations=[
  {id:'welcome',n:1,x:807,y:304,w:26,h:62,title:'WELCOME',lines:['Seating assignments','A few framed photos'],detail:'One 6-ft table for seating assignments and a few framed photos. Guests approach from the centre of the lobby.'},
  {id:'mirror',n:2,x:746,y:214,w:13,h:29,title:'MIRROR',lines:['Welcome greeting'],detail:'Welcome mirror just inside the main entrance, beside the welcome display; allow for its stand.'},
  {id:'memorial',n:3,x:608,y:410,w:62,h:26,title:'MEMORIAL',lines:['Quiet remembrance'],detail:'One 6-ft memorial table in the quieter lower corner of the arrival lobby.'},
  {id:'guestbook',n:4,x:571,y:335,w:26,h:62,title:'GUEST BOOK',lines:['Polaroid + photos'],detail:'One 6-ft side table for the guest book, Polaroid camera, spare film, pens and photos.'},
  {id:'boba',n:5,x:772,y:218,w:62,h:26,title:'BOBA',lines:['Near main entrance'],detail:'Boba cart beside the rear main entrance. Its queue stays in the upper-right pocket, away from the welcome table and doorway.'},
 ...
 const routes=[
  {id:'arrival',points:'697,205 697,395 840,395',width:42},
 ...
 const queues=[
  {id:'boba-queue',x:772,y:248,w:62,h:42},
 ...
 const views={all:{label:'Whole venue',box:'225 155 1440 1045'},arrival:{label:'Welcome lobby',box:'540 170 320 290'},alba:{label:'Alba & bar',box:'245 675 660 525'}};
