...
(function(root){
 ...
 const stations=[
  ...
  {id:'boba',n:5,...venueRect(monza.boba),title:'BOBA CART',lines:['Inside Monza','Near rear-lobby entry'],detail:'Boba inside Monza, in the corner beside the rear-lobby doorway: STAFF stand against the rear wall and serve over the cart in front of them (the setup intrudes on the reserved blue space by design). The QUEUE lines up on the blue 5-ft wall-route strip along the left wall, south of the door opening. Confirm the supplier footprint.'},
