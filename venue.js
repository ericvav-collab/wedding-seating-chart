...
(function(root){
 ...
 const stations=[
  ...
  {id:'boba',n:5,...venueRect(monza.boba),title:'BOBA CART',lines:['Inside Monza','Near rear-lobby entry'],detail:'Boba inside Monza, tight to the rear-lobby doorway (0.5 ft clear of the door swing): STAFF stand against the rear wall and serve over the cart, which sits in front of them and may intrude on the reserved blue space. A separate 3.5-ft queue runs along the wall away from the door. Confirm the supplier footprint.'},
