...
'Boba is INSIDE MONZA, in the corner beside the rear-lobby doorway:',
'STAFF against the rear wall, 6 x 2.5-ft cart in front of them (setup',
'intrudes on the blue reserved space by design). The QUEUE lines up on',
'the blue 5-ft wall-route strip south of the door. Keep the door clear.',
'',
