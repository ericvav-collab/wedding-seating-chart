...
'Boba is INSIDE MONZA, tight to the rear-lobby doorway: STAFF stand',
'against the rear wall and serve over the 6 x 2.5-ft cart in front of',
'them (the cart may intrude on the reserved blue space). The 3.5-ft',
'queue runs along the wall away from the door. Keep door access clear.',
'',
...
'D: Same compact U as A, but the PARENTS\u2019 TABLES (1 and 7) may sit into',
'   the keep-open lane between the head table and dance floor \u2014 parents',
'   front and centre of the couple. Zero overlaps, 1.1-ft minimum gap:',
'   a meaningfully better fit than A while keeping the U head table.',
'Boba: staff against the rear Monza wall, cart in front of them, tight',
'to the rear-lobby doorway (0.5 ft clear of the door); queue runs along',
'the wall away from the door. Cart may sit into the blue reserved space.',
